...
var csv = /** @class */ (function () {
    ...
    csv.prototype.renameCol = function (input_header) {
        this.csv_array[0] = input_header;
        return this;
    };
    csv.prototype.reorder = function (order) {
        var order_in_num = [];
    ...
    csv.prototype.after = function (line_after, f, header) {
    ...
    csv.prototype.title = function (input_title) {
    ...
    csv.prototype.print = function () {
        console.log(this._title);
        console.log('-----------');
        console.log(this.csv_array);
        return this;
    };
    csv.prototype["export"] = function (name, rootDat) {
        if (rootDat === void 0) { rootDat = __dirname + '/../../..'; }
        this._title.reverse();
        ...
        rootDat += '/' + name;
        require('fs').writeFile(rootDat, out_string, function (err) { });
    };
    return csv;
}());
exports["default"] = csv;
